...
import 'package:paint/utils/extenstions.dart';
import 'package:paint/utils/mobileutils.dart';
import 'package:paint/utils/smallcontainers.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                SizedBox(height: 47.h, width: 95.w, child: Image.asset("assets/images/appbarpaint.png")),
                SizedBox(height: 18.h, width: 50.w, child: Image.asset("assets/images/lenguage.png")),
              ],
            ),
            Divider(
              thickness: 0.75.sp,
            ...
            30.height(),
            context.screenwidth() >= 800 ? const FirstContainerWindows() : FirstContainerMobile(),
            20.height(),
            context.screenwidth() >= 800 ? const SecondContainerWindows() : const SecondContainerMobile(),
            20.height(),
            context.screenwidth() >= 800 ? const BlackWindows() : const BlackMobile(),
            20.height(),
            context.screenwidth() >= 800 ? const CustomersWindows() : const CustomersMobile(),
            20.height(),
            context.screenwidth() >= 800 ? const BigCourseWindows() : const BigCourseMobile(),
            20.height(),
            const Text(
            ...
            20.height(),
            context.screenwidth() >= 800 ? const EndContainerWindows() : const EndContainerMobile(),
          ],
        ),
      ),
    );
